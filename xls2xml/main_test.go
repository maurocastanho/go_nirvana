...
func TestXmlBoxSeries(t *testing.T) {
	...
	assetsL := [][]string{
		{"uuid_box", "uuid_trailer",
			...
			"Título Original",
			"Título em Português",
			"Numero Temporada", "Número do Episódio", "Título em Português do Episódio",
			"ID",
			"Versao", "Língua Original ", "Linguagem Áudio", "Linguagem Legenda",
			"Categoria", "Ano", "Bilheteria", "Ranking",
			"Estúdio", "Classificação Etária", "Genero 1", "Genero 2",
			...
			"Provider ID", "Billing ID", "Cobrança",
			"Movie Audio Type",
			"Trailer ID", "Trailer Size", "Trailer Audio Type",
			"subpasta",
			"preço",
			"Linguagem Trailer",
			"Linguagem Legenda Trailer",
		...
		{"9dcccf62-1dee-44f3-87e8-f19433bbfe59", "84a7933b-f4ad-4817-9473-64f33340a72e", "58b6618b-7637-43b0-8ad9-9b7891ba6eec",
			...
			"0.017615740740741", "06-25-20", "12-31-26", "HD",
			"", "", "",
			"stereo",
			"", "", "",
			"docs",
		...
		{"37cbb97d-815c-45f7-a927-6fa2e04512ba", "650dcfca-35bd-4b3c-b0b6-a3c68409804d", "072356bc-d774-4e79-a05d-4e5c52dc56d9",
			...
			"A melhor série de contagem regressiva de esportes. Com temas icônicos focados nos momentos e indivíduos mais memoráveis do esporte.",
			"0.017696759259259", "06-25-20", "12-31-26", "HD",
			"", "", "",
			"stereo",
			"", "", "",
			"docs",
